...
const Navbar = () => {
 ...
 return (
    <nav className='bg-gray-900 flex  text-white justify-between px-4 md:h-16 flex-col md:flex-row items-center '>
        
        
          <Link href={"/"}  className="logo font-bold text-lg flex justify-center items-center gap-2">
          <img src="https://media.tenor.com/2Wu29iaHSYYAAAAi/coffee-lover-hot-coffee.gif" width={44} className='relative top-[-14px] invertImg' alt="" />
          <span className='text-xl md:text-base my-3 md:my-0'>GetTea!!</span>
          </Link>
